...
#compile_model "${shdirpath}/uncompiled/models/survivors/survivor_namvet/survivor_namvet.qc" "${srcpath}"
#compile_model "${shdirpath}/uncompiled/models/survivors/namvet/namvet_deathpose/namvet_deathpose.qc" "${srcpath}"
compile_model "${shdirpath}/uncompiled/models/weapons/arms/v_arms_bill/v_arms_bill.qc" "${srcpath}"
