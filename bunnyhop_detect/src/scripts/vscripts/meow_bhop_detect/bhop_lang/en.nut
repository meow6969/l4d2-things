...
::BhopLang.EN <-
{
	...
	Misc =
	{
		Introduction				= "hello %%NAME%%! you seem to be new to MeowBhopDetect!\n"+
									  "enter \"%%OLIVE_GREEN%%%%PREFIX_NO_QUOTES%% help%%WHITE%%\" to see the help command, and do \"%%OLIVE_GREEN%%%%PREFIX_NO_QUOTES%% toggle%%WHITE%%\" to enable/disable me!",
	...
	BhopAnnounce = 
	{
		...
		InARowSingular				= "%%NAME%% got %%NUM_BHOPS%% bunnyhop in a row",
		// InARowMultiple				= "%%NAME%% got %%NUM_BHOPS%% bunnyhops in a row (score: %%SCORE%%, top speed: %%TOP_SPEED%%, avg speed: %%AVG_SPEED%%)",
		InARowMultiple				= "%%NAME%% got %%NUM_BHOPS%% bunnyhops in a row",

		Score						= "score: %%SCORE%%",
		TopSpeed					= "top speed: %%TOP_SPEED%%",
		AvgSpeed					= "avg speed: %%AVG_SPEED%%",
		...
		BeatPBScore					= "%%NAME%% beat their bunnyhop record! %%SCORE_DIFFERENCE%% points!",
		BeatPBVelocity				= "%%NAME%% beat their bunnyhop record! %%SCORE_DIFFERENCE%% velocity!",
		BeatPBBhops					= "%%NAME%% beat their bunnyhop record! %%SCORE_DIFFERENCE%% bhops!",

		BeatSessionPBScore			= "%%NAME%% beat their session bunnyhop record! %%SCORE_DIFFERENCE%% points!",
		BeatSessionPBVelocity		= "%%NAME%% beat their session bunnyhop record! %%SCORE_DIFFERENCE%% velocity!",
		BeatSessionPBBhops			= "%%NAME%% beat their session bunnyhop record! %%SCORE_DIFFERENCE%% bhops!"
	}
	...
	Commands =
	{
		...
		settings =
		{
			...
			ErrorInputNotArray		= "ERROR: user input is not of array type: %%USER_INPUT%%",
