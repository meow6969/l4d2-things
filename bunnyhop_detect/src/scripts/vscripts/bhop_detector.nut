...
::BhopEvent <-
{
	...
	function OnGameEvent_player_say(params)
	{
		...
		if (message == "!bhop stats")
		{
			...
			ClientPrint(player,5,"\x01high score: \x04"+best["score"]+"\x01, total distance bhopped: \x04"+pSet["TotalDistanceBhopped"]+"\x01, highest velocity: \x04"+pSet["HighestVelocity"]+"\x01");
			return true;
		}
